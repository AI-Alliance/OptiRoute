        ...
        while len(unvisited_clients) != 0:
            ...
            for vehicle in vehicles:
                ...
                for client in unvisited_clients:
                    possible_distance = task.distance_matrix[last_place_visited_by_vehicle.place_index][client.place_index]
                    if vehicle.capacity >= client.demand and possible_distance < shortest_distance:
